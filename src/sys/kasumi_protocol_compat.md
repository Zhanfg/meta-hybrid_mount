...
2. **Architecture and failure-path review**: Kasumi mirror preparation, local Magic Mount downgrade, transactional Kasumi activation, bind-mount rollback, feature-gated builds and WebUI ownership state.
...
- a deliberately failing module proving failure isolation;
- WebUI status consistency;
