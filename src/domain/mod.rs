...
impl ModuleRules {
    ...
    /// Build execution-only rules for a module whose Kasumi mirror failed.
    /// Existing Overlay, Magic and Ignore decisions remain unchanged; only
    /// Kasumi-selected paths are redirected to Magic Mount for this boot.
